...
using {
    ...
    DEALER_PORTAL_RETAILER_REGISTRATION.REGION_MASTER,
...
} from '../db/MASTER_TABLE';
// using {DEALER_PORTAL.MASTER_REGION} from '../db/MASTER_TABLES';
...
entity RETAILER_EVENT {
 ...
 entity RETAILER_ADDRESS_DETAIL {
        ...
        key SR_NO : Integer;
            ...
            TO_REGION        : Association to one REGION_MASTER
                            on TO_REGION.REGION_CODE = REGION;
            TO_CITY          : Association to one CITY_MASTER
